    ...
    <div ref={containerRef} className="min-h-screen bg-black text-white selection:bg-emerald-500/30 overflow-x-hidden pt-20">
      ...
      <section className="relative h-screen flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 max-w-6xl mx-auto">
          ...
          >
            MASTER <br />
            <span className="text-emerald-500 drop-shadow-[0_0_50px_rgba(16,185,129,0.35)]">THE GREEN</span>
          </motion.h1>
          ...
          >
            Elevate every swing with the ultimate Stableford network. 
            Real-time global rankings, precision analytics, and weekly championships.
          </motion.p>
        ...
        <div className="absolute bottom-20 left-10 hidden lg:block opacity-30 select-none pointer-events-none">
          <div className="space-y-4">
            <div className="flex items-center gap-4">
              ...
              <span className="text-[10px] font-black tracking-widest uppercase">STABLEFORD v4.0</span>
            </div>
      ...
      <section id="features" className="px-6 py-32 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-6 h-auto md:h-[800px]">
          ...
          <BentoCard
            className="md:col-span-2 bg-zinc-900/40 border-white/5"
            title="Global Hub"
            desc="Connect with enthusiasts worldwide."
          ...
          <div className="md:col-span-4 bg-gradient-to-br from-emerald-500 to-emerald-800 rounded-[2.5rem] p-10 flex flex-col justify-between group cursor-pointer overflow-hidden relative">
            <div className="relative z-10">
              ...
              <p className="text-black/80 font-bold max-w-md leading-relaxed">Join 5,000+ golfers who have already elevated their game through the GOLF HERO network.</p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
          <div>
            ...
            <div className="space-y-6">
              <StatItem label="Active Players" value="5,240+" />
              <StatItem label="Prizes Awarded" value="£125,000+" />
              <StatItem label="Verified Rounds" value="48,000+" />
            </div>
          </div>
